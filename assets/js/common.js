window.onload = function() {
    ...
    var intervalId = setInterval(function() {
        if (fileName === "index.html") {
            secondLiA = document.querySelector("header .container .gnb-menu ul li:nth-child(1) a");
        } else if (fileName === "about.html") {
            secondLiA = document.querySelector("header .container .gnb-menu ul li:nth-child(2) a");
        } else if (fileName === "work.html") {
            secondLiA = document.querySelector("header .container .gnb-menu ul li:nth-child(3) a");
        }
